...
% y_train(71:105) = randi([y1,y2], [35,1]);
...
fprintf("Added " + num_outliers + " outliers to training dataset (class 3)\n");
...
threshold_correct = value_outlier(n_train - num_outliers);
...
min_threshold = value_outlier(floor(n_train/3*2)); % mid way
